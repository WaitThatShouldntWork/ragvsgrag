from neo4j_db.graph_schema import graph_schema
from neo4j_db.graph_schema import narrative_options
...
Check whether the user question matches one of the narrative options: {narrative_options}
