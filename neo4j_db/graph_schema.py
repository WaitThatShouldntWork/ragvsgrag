narrative_options = "Bills, Groceries, Entertainment, Rent, Shopping, Budgeting tips, Budgeting money"
...
Document {{text: STRING, source: STRING, title: STRING}}
Guidance {{id: STRING}}
_Entity_ {{id: STRING}}
